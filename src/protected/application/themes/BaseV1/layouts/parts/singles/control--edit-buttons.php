...
<?php if($entity->usesDraft()): ?>
    <?php if($entity->isNew() || $entity->status === $status_draft):  ?>
        ...
        <a class="btn btn-primary js-submit-button hltip" data-status="1" hltitle="<?php printf(\MapasCulturais\i::esc_attr__('Salvar e publicar este %s.'), $entity->getEntityTypeLabel()); ?>"><?php \MapasCulturais\i::_e("Publicar");?></a>
