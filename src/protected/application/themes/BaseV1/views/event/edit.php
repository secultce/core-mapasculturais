...
<div id="event-occurrence-{{id}}" class="regra clearfix" data-item-id="{{id}}">
    ...
    {{#pending}}
        <div class="alert warning pending"><?php \MapasCulturais\i::_e("Aguardando confirmação"); ?></div>
    {{/pending}}
    ...
    <?php if ($this->isEditable()) : ?>
        <div class="clear">
            <a class="btn btn-default edit js-open-dialog hltip" data-dialog="#dialog-event-occurrence" data-dialog-callback="MapasCulturais.eventOccurrenceUpdateDialog" data-dialog-title="<?php \MapasCulturais\i::esc_attr_e('Modificar local e data'); ?>" data-form-action="edit" data-item="{{serialized}}" href="#" title='<?php \MapasCulturais\i::esc_attr_e('Editar local e data'); ?>'><?php \MapasCulturais\i::_e("Editar"); ?></a>
    ...
    <header class="main-content-header">
        ...
        <div class="container-card">
            <div class="header-content">
                ...
                <div class="widget areas">
                    <div class="widget card-event">
                        ...
                        <?php else : ?>
                            <?php $linguagens = array_values($app->getRegisteredTaxonomy($entity->getClassName(), 'linguagem')->restrictedTerms);
                            sort($linguagens); ?>
            ...
            <?php if ($this->isEditable() || $entity->site) : ?>
                <div class="widget">
                    <h3 <?php echo ($entity->isPropertyRequired($entity, "site") && $editEntity ? 'required' : ''); ?>"><?php \MapasCulturais\i::_e("Site"); ?></h3>
                    <?php if ($this->isEditable()) : ?>
    ...
    <div class="tabs-content">
        ...
        <div id="sobre" class="aba-content">
            ...
            <div class="ficha-spcultura">
                ...
                <?php if ($this->isEditable()) : ?>
                    <div class="textright">
                        <a class="btn btn-default add js-open-dialog hltip" data-dialog="#dialog-event-occurrence" href="#" data-dialog-callback="MapasCulturais.eventOccurrenceUpdateDialog" data-dialog-title="<?php \MapasCulturais\i::esc_attr_e('Adicionar local e data'); ?>" data-form-action='insert' title="<?php \MapasCulturais\i::esc_attr_e('Clique para adicionar local e data'); ?>">
...
<div class="sidebar-left sidebar event">
    ...
    <?php if ($this->isEditable()) : ?>
        <div class="widget">
            ...
            <?php else : ?>
                <a class="js-search js-include-editable" data-field-name='projectId' data-emptytext="<?php \MapasCulturais\i::esc_attr_e('Selecione um projeto'); ?>" data-search-box-width="400px" data-search-box-placeholder="<?php \MapasCulturais\i::esc_attr_e('Selecione um projeto'); ?>" data-entity-controller="project" data-search-result-template="#agent-search-result-template" data-selection-template="#agent-response-template" data-no-result-template="#agent-response-no-results-template" data-selection-format="chooseProject" data-multiple="true" data-allow-clear="1" data-auto-open="true" data-value="<?php echo $entity->project ? $entity->project->id : ''; ?>" data-value-name="<?php echo $entity->project ? $entity->project->name : ''; ?>" title="<?php \MapasCulturais\i::esc_attr_e('Selecionar um Projeto'); ?>">
